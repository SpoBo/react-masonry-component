...
var MasonryComponent = React.createClass({
    ...
    diffDomChildren: function() {
        ...
        if (!removed.length && !appended.length && !prepended.length && !moved.length) {
          heightChanged = oldChildren.some(function(child, index) {
            return index.clientHeight !== newChildren[index].clientHeight;
          });
        }
